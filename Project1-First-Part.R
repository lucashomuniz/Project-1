...
# Clears the revenue and subscription dataset and combines it with the previous dataframe "data_netflix_pib_salario2020", leaving only the revenue and subscription of (Q4.2021)
